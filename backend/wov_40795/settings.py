"""
Django settings for wov_40795 project.
...
WSGI_APPLICATION = 'wov_40795.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wov_40795 API",
    "DESCRIPTION": "API documentation for wov_40795 App",
    "VERSION": "v1",
}
